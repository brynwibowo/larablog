  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="ModalLabel">Add New Users</h5>
		...
		@csrf      
				...
				<div class="form-group">
                    ...
                    <input type="password" id="formPassword" class="form-control" wire:model="password" placeholder="********">
					@error('password') <span class="text-danger">{{ $message }}</span>@enderror
                </div>
				<div class="form-group">
                    <label for="formConfirmPassword">Confirm Password</label>
                    <input type="password" id="formConfirmPassword" class="form-control" wire:model="confirmPassword" placeholder="********">
