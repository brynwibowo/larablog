    ...
    <section id="breadcrumbs2" class="breadcrumbs2">
      <div class="breadcrumb-hero">
        <div class="container">
          <div class="breadcrumb-hero">
            <h2>Kontak</h2>
            <p>Informasi alamat dan nomor telepon yang bisa dihubungi di Pondok Pesantren Nurul Ummah Kebumen</p>
          </div>
        </div>
      </div>
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="info-box mb-4">
              <i class="bx bx-map"></i>
              <h3>Alamat Kami</h3>
              <p>Jl. Raya Ijo-Jatijajar, Kaliputri, Mangunweni, Ayah, Kabupaten Kebumen, Jawa Tengah 54473</p>
            </div>
          </div>
